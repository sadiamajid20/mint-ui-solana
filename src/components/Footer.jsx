    ...
    <section class="bg-black">
      <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center mt-8 space-x-6">
          ...
          <a href="https://www.instagram.com/thebirdsofpamparigouste/" class="text-gray-400 hover:text-gray-500">
        ...
        <p class="mt-8 jura-font text-base leading-6 text-center text-gray-400">
          © 2025 Phi | Inc. All rights reserved.
        </p>
      </div>
    </section>
  );
